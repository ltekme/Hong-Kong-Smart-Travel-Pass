...
export const Hello = ({ confirmAgree, setFacebookProfile }: IHello) => {
    ...
    try {
      const processProfileData = async (
        ...
        try {
          ...
          console.log(
            `Got faceboot response ${JSON.stringify(
              profileDetails,
              null,
              4
            )} for ${profileDetails.name}`
          );
      ...
      window.FB.login(function (loginResponse) {
        if (loginResponse.authResponse) {
          ...
          window.FB.api(
            ...
            (e) => {
              processProfileData(e, loginResponse);
            }
          );
        }
      });
              ...
              >
                ...
                >
                  ...
                  <div className="social-icons w3layouts">
                    <ul>
                      <li>
                        <p onClick={handleFBLogin} className="facebook">
